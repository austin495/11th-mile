...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-60", className)}>
      <div className="call-to-action_main relative z-10">
        <div className="inner-wraper max-w-[1440px] m-auto flex flex-col items-center justify-center gap-5">
            <MaskText
                styles={{
                    maskText: "text-[45px] font-sans font-semibold w-[60%] text-center leading-[1.2em]",
                    lineMask: "overflow-hidden",
                }}
                title="We decode the DNA of your brand and write the next chapter with you."
            />
            <p className="text-[18px] font-sans font-normal">From startups to global players over 150 brand stories rewritten, each rooted in authentic DNA.</p>
            <div className="relative inline-flex items-center justify-center gap-4 mt-[15px] group">
                <a
                    href="#"
                    title="payment"
                    className="group relative inline-flex items-center justify-center text-base rounded-xl bg-[#181818] px-8 py-3 font-semibold text-white transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30"
                    role="button"
                >
                    Start Your Chapter
                    <svg
      ...
      <svg
        ...
        className="absolute -top-60  md:-top-117 w-full"
      >
        <motion.path
